...
| Runtime helpers | `scripts/conflict-status.sh`, `scripts/categorize-conflicts.sh`, `scripts/validate-resolution.sh`, `scripts/detect-stacked-pr.sh`, `scripts/historical-resolution-search.sh`, `scripts/semantic-audit.sh`, `scripts/suggest-pr-split.sh`, `scripts/open-stacked-prs.sh` |
