...
| `suggest-pr-split.sh` | Propose functional/structural split groups for a large change or conflict |
| `open-stacked-prs.sh` | Materialize a split plan as stacked GitHub PRs (dry-run by default; requires `gh` to execute) |
